...
public class FrmPagamentoBoleto extends FrmPagamento {
	...
	public void init() {
		...
		cDataVencimento.setRotulo("1. Vencto");
	...
	private void calcular() {
		...
		calcularValorPagar(MeioPagamento.BOLETO, 1);
	...
	private void confirmar() {
		try {
			if (SSMensagem.confirma("Confirma adicionar este pagamento")) {
				...
				//calcular();
				adicionarParcelamento(cDataVencimento.getLocalDate(), 1);
