package digytal.desktop.components.desktop.ss.util;
...
public class SSReflexao {
	public static Object buscarValorCampo(Object objeto, String nomeCampo) throws NoSuchFieldException, IllegalAccessException {
		return buscarValorCampo(objeto, nomeCampo, false);
	}
    public static Object buscarValorCampo(Object objeto, String nomeCampo,boolean porAtributo) throws NoSuchFieldException, IllegalAccessException {
        Field campo = null;
        ...
        if(porAtributo) {
        	...
        	valor = campo.get(objeto);
        	  ...
        	  Method metodo;
        	  try {
        	 if(objeto instanceof Enum && porAtributo) {
    ...
    public static Object buscarValorCampoRecursivo(Object objeto, String nomeCampo) throws NoSuchFieldException, IllegalAccessException {      
    	return buscarValorCampoRecursivo(objeto, nomeCampo,false);
    }
    public static Object buscarValorCampoRecursivo(Object objeto, String nomeCampo,boolean porAtributo) throws NoSuchFieldException, IllegalAccessException {        
        ...
        while(token.hasMoreElements()) {
            ...
            if (objeto == null)
                return null;
            if (nomeCampo != null) {                                
                valor = buscarValorCampo(objeto, nomeCampo,porAtributo);   
                objeto = valor;
            }
        }
        return valor;
    ...
    public static Object definirValorCampo(Object objeto, String nomeCampo, Object valor,boolean porAtributo) throws NoSuchFieldException, IllegalAccessException {
        Field campo = null;
        Class classe = objeto.getClass();
        while (classe != null && campo == null) {
            try {
    ...
    public static void definirValorCampoRecursivo(Object objeto, String nomeCampo, Object valor) throws NoSuchFieldException, IllegalAccessException {    
    	definirValorCampoRecursivo(objeto, nomeCampo, valor, false);
    }
    
    public static void definirValorCampoRecursivo(Object objeto, String nomeCampo, Object valor,boolean porAtributo) throws NoSuchFieldException, IllegalAccessException {        
        StringTokenizer token = new StringTokenizer(nomeCampo, ".", false);        
        ...
        while(token.hasMoreElements()) {
            ...
            if (nomeCampo != null) {
                if (i == quantCampos)
                    definirValorCampo(objeto, nomeCampo, valor,porAtributo);
                else
    ...
    public static void copiarAtributos(Object origem, Object destino, String[] atributos) throws Exception {
        ...
        for (String atributo : atributos) {        
            ...
            definirValorCampo(destino, atributo, valorOrigem,false);            
        }
    }
