package digytal.desktop.components.desktop.ss.tabela;
...
public class SSModeloColuna extends DefaultTableColumnModel {
    ...
    public void definirPositivoNegativo(int x) {
    	setCorFonte(x, new Color(0, 0, 139), new Color(128, 0, 0));
    }
...
{	
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column)
    {
    	...
    	if(value!=null && value.toString().startsWith("-"))
            setForeground(cor.length==0?cor[0]:cor[1]);
    	else if(value!=null && value.toString().equals("0,00")) {
