...
public class FrmConsultaTransacaoDespesa extends FormularioGestao {
	...
	public FrmConsultaTransacaoDespesa() {
		setTitulo("Consulta de Despesas");
		setDescricao("Consulta gerencial das transações de despesas");
		...
		tabela.adicionarColuna(4, "Centro Custo", "area.descricao");
		tabela.adicionarColuna(5, "Natureza", "natureza.descricao");
		tabela.adicionarColuna(6, "Cadastro", "cadastro.descricao");
		
		tabela.definirLarguraColunas(40, 55,150,90, 110,110,200);
	...
	public void filtrar() {
		...
		List<TransacaoResponse> response = service.pesquisarCompleta(filtro);
		if(response.size()==0) {
