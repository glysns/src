...
@Repository
public interface InscricaoAlunoSourceRepository extends JpaRepository<InscricaoAlunoSourceEntity, String> {
    public List<InscricaoAlunoSourceEntity> findByIdGreaterThan(Integer id);
}