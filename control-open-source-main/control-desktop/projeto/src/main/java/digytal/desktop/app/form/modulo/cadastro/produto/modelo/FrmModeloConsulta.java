...
public class FrmModeloConsulta extends FormularioConsulta {
	...
	public FrmModeloConsulta() {
		setTitulo("Modelos");
		setDescricao("Listagem dos Modelos dos Produtos");
		...
		bIncluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				incluir(Context.getBean(FrmModeloCadastro.class));
			}
		});
		
		bAlterar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				alterar(Context.getBean(FrmModeloCadastro.class));
			}
		});
	...
	public void filtrar() {
		try {
			...
			List<ModeloResponse> registros = service.consultar(nome);
