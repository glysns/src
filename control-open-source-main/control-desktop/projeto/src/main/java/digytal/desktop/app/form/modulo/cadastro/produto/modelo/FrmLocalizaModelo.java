...
public class FrmLocalizaModelo extends FormularioLocaliza {
	...
	public FrmLocalizaModelo() {
		init();
	}

	public void init() {
		super.setTitulo("Unidades de Medida");
		super.setDescricao("Localização de Unidades de Medida");
