...
public class SSCaixaCombinacao extends SSComponenteRotulado {
    ...
    private Object buscarCampo(String nomeCampo, Object objeto) {                
        ...
        if (nomeCampo != null) {            
            try {
                valor = SSReflexao.buscarValorCampoRecursivo(objeto, nomeCampo,porAtributo);
    ...
    private void criarBotaoPesquisa() {
        if (btnPesquisa == null) {
            ...
            btnPesquisa.setIcone("folder");
            btnPesquisa.setMargin(new Insets(2, 1, 1, 1));
    ...
    public void setBotaoPesquisaIcone(String icone) {
    	 btnPesquisa.setIcone(icone);
    }
