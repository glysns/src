...
public class PainelParcelamentoDetalhe extends JPanel {
	...
	public PainelParcelamentoDetalhe() {
		...
		JLabel lblNewLabel = new JLabel("CPF \\ CNPJ do Cadastro:");
	...
	private void atualizarCampos() {
		...
		ParcelamentoDetalhe n = p.getDetalhe();
		Associacao c = p.getCadastro();
		...
		cCpfCnpjNomeFantasia.setText(c.getIdentificador().toString());
		cCelularSobrenomeSocial.setText(c.getDescricao());
	}
