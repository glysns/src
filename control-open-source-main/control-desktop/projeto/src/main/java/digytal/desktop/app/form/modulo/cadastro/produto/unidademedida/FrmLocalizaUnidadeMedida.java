...
public class FrmLocalizaUnidadeMedida extends FormularioLocaliza {
	...
	public FrmLocalizaUnidadeMedida() {
		init();
	}

	public void init() {
		super.setTitulo("Modelos");
		super.setDescricao("Localização de Modelos");
		...
		getTabela().adicionarColuna(2, "Sigla", "abreviacao");
		
		getTabela().definirLarguraColunas(30, 220,50);
